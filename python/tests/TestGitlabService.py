...
class TestGitlabService(unittest.TestCase):
    ...
    #     result = self.gitlab_service.register_gitlab_runner()
    #     self.assertRegex(str(result),  r'Runner registered successfully')
    #     self.assertNotRegex(str(result),  r'Runner registered successfully')
    #     # self.assertEqual(len(registration_key), 20)
    #     pass

    # def test_register_gitlab_runner_should_fail(self):
    #     result = self.gitlab_service.register_gitlab_runner(registration_key="fake")
    #     self.assertRegex(str(result),  r'Registering runner... forbidden')
    #     # self.assertEqual(len(registration_key), 20)
    #     pass
